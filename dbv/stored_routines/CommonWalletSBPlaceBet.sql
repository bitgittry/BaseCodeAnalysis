DROP procedure IF EXISTS `CommonWalletSBPlaceBet`;

DELIMITER $$
CREATE DEFINER=`bit8_admin`@`127.0.0.1` PROCEDURE `CommonWalletSBPlaceBet`(transactionRef VARCHAR(40), sessionID BIGINT, clientStatID BIGINT, canCommit TINYINT(1), OUT statusCode INT)
root: BEGIN
