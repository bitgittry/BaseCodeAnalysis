-- -------------------------------------
-- BonusGetDepositRules.sql
-- -------------------------------------
DROP procedure IF EXISTS `BonusGetDepositRules`;

DELIMITER $$
CREATE DEFINER=`bit8_admin`@`127.0.0.1` PROCEDURE `BonusGetDepositRules`(bonusRuleIDArray TEXT)
BEGIN
	...
	SELECT gaming_bonus_rules.bonus_rule_id, gaming_bonus_rules.name, gaming_bonus_rules.description, gaming_bonus_types.name AS bonus_type_name, priority, activation_start_date, activation_end_date, program_cost_threshold,
		...
		no_loyalty_points, pre_expiry_days, redeem_threshold_enabled, voucher_code, restrict_by_voucher_code, gaming_bonus_rules.comments,gaming_bonus_rules.linking_type, gaming_bonus_rules.redeem_threshold_on_deposit, gaming_bonus_rules.terms_and_conditions,ring_fenced_by_bonus_rules,ring_fenced_by_license_type,award_bonus_max,
		date_eligable_check, currency_profile_id, game_weight_profile_id, sb_weight_profile_id, lotto_weight_profile_id, sportspool_weight_profile_id, gaming_bonus_rules.bonus_custom_type_id, max_count_per_interval, is_generic, gaming_bonus_rules.awarded_times, gaming_bonus_rules.awarded_times_threshold,
	...
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rules_deposits_amounts.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id 
	...
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rules_deposits_percentages.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id; 
	...
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND pay_methods.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id; 
	...
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rules_deposits_ranges.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id 
	JOIN gaming_currency ON gaming_bonus_rules_deposits_ranges.currency_id=gaming_currency.currency_id;


	SELECT gaming_bonus_rule_max_awarding.bonus_rule_id,max_amount, gaming_currency.currency_id, currency_code 
	FROM gaming_bonus_rule_max_awarding 
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rule_max_awarding.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id 
	...
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rules_weekdays.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id;
