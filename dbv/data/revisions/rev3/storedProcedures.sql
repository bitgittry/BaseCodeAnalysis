...
CREATE DEFINER=`bit8_admin`@`127.0.0.1` PROCEDURE `CommonWalletSportsGenericPlaceBet`(sbBetID BIGINT, OUT statusCode INT)
root: BEGIN
  -- First Version :) 
...
root:BEGIN
    ...
    -- If Wager Status Code is ReadyForGedddtFunds Skip Validation
