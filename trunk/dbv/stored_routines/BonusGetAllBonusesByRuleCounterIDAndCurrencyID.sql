-- -------------------------------------
-- BonusGetAllBonusesByRuleCounterIDAndCurrencyID.sql
-- -------------------------------------
DROP procedure IF EXISTS `BonusGetAllBonusesByRuleCounterIDAndCurrencyID`;

DELIMITER $$
CREATE DEFINER=`bit8_admin`@`127.0.0.1` PROCEDURE `BonusGetAllBonusesByRuleCounterIDAndCurrencyID`(bonusRuleGetCounterID BIGINT, currencyID BIGINT, operatorGameIDFilter BIGINT, returnManualBonus TINYINT(1))
BEGIN
	...
	SELECT gaming_bonus_rules.bonus_rule_id, gaming_bonus_rules.name, gaming_bonus_rules.description, gaming_bonus_types.name AS bonus_type_name, gaming_bonus_rules.priority, 
		...
		gaming_bonus_rules.wager_requirement_multiplier, gaming_bonus_rules.expiry_date_fixed, gaming_bonus_rules.expiry_days_from_awarding, gaming_bonus_rules.allow_awarding_bonuses, 
        gaming_bonus_rules.awarded_total, gaming_bonus_rules.added_to_real_money_total, gaming_bonus_rules.operator_id, gaming_bonus_rules.empty_selection, gaming_bonus_rules.player_selection_id,
		gaming_bonus_rules.datetime_created, gaming_bonus_rules.is_active, gaming_bonus_rules.is_hidden, gaming_bonus_types_awarding.name AS bonus_awarding_type,
		gaming_bonus_types_bet_returns.name AS bonus_bet_return_type, gaming_bonus_types_transfers.name AS bonus_transfer_type, gaming_bonus_types_release.name AS bonus_release_type, 
        gaming_bonus_rules.wager_req_real_only, gaming_bonus_rules.transfer_upto_percentage, gaming_bonus_rules.transfer_every_x_wager, 
		gaming_bonus_rules.min_odd, gaming_bonus_rules.withdrawal_limit_num_rounds, gaming_bonus_rules.over_max_bet_win_contr_multiplier, 
        ...
        gaming_bonus_rules.casino_weight_mod, gaming_bonus_rules.poker_weight_mod, gaming_bonus_rules.sportsbook_weight_mod, 
        gaming_bonus_rules.lottery_weight_mod, gaming_bonus_rules.poolbetting_weight_mod, gaming_bonus_rules.sportspool_weight_mod,
        gaming_bonus_rules.restrict_platform_type, gaming_bonus_rules.forfeit_on_withdraw,
        ...
        gaming_bonus_rules_deposits_amounts.min_deposit_amount AS deposit_min_deposit_amount,
		-- Other core
        gaming_bonus_rules.is_free_bonus, gaming_bonus_rules.no_loyalty_points, gaming_bonus_rules.pre_expiry_days, gaming_bonus_rules.redeem_threshold_enabled, 
        gaming_bonus_rules.voucher_code, gaming_bonus_rules.restrict_by_voucher_code, gaming_bonus_rules.comments,
        gaming_bonus_rules.linking_type, gaming_bonus_rules.redeem_threshold_on_deposit,
        gaming_bonus_rules_deposits.ring_fenced_by_bonus_rules, gaming_bonus_rules_deposits.ring_fenced_by_license_type, 
        gaming_bonus_rules.award_bonus_max, gaming_bonus_rules.date_eligable_check, 
        gaming_bonus_rules.currency_profile_id, gaming_bonus_rules.game_weight_profile_id, gaming_bonus_rules.sb_weight_profile_id, 
        gaming_bonus_rules.lotto_weight_profile_id, gaming_bonus_rules.sportspool_weight_profile_id, gaming_bonus_rules.bonus_custom_type_id, gaming_bonus_rules.max_count_per_interval, 
        gaming_bonus_rules.is_generic, gaming_bonus_rules.awarded_times, gaming_bonus_rules.awarded_times_threshold,
		...
		gaming_bonus_rules.num_free_rounds_threshold, gaming_bonus_rules.num_free_rounds_awarded, gaming_bonus_rules.num_prerequisites_or, gaming_bonus_rules.is_default,
		-- login
	...
	STRAIGHT_JOIN gaming_bonus_rules ON 
		gaming_bonus_rule_get_counter_rules.bonus_rule_get_counter_id=bonusRuleGetCounterID AND 
		gaming_bonus_rules.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id AND 
	...
	-- direct give
    LEFT JOIN gaming_bonus_rules_direct_gvs_amounts ON gaming_bonus_rules.bonus_rule_id=gaming_bonus_rules_direct_gvs_amounts.bonus_rule_id AND gaming_bonus_rules_direct_gvs_amounts.currency_id=gaming_currency.currency_id 
	-- login
	...
	LEFT JOIN gaming_bonus_awarding_interval_types AS deposit_awarding_interval_table ON gaming_bonus_rules_deposits.bonus_awarding_interval_type_id=deposit_awarding_interval_table.bonus_awarding_interval_type_id   
	LEFT JOIN gaming_bonus_rules_deposits_amounts ON gaming_bonus_rules.bonus_rule_id=gaming_bonus_rules_deposits_amounts.bonus_rule_id AND gaming_bonus_rules_deposits_amounts.currency_id=gaming_currency.currency_id;
	
	SELECT 
		gaming_operator_games.game_id, gaming_operator_games.operator_game_id, gaming_bonus_rules_wgr_req_weights.bonus_rule_id, 
	...
	FROM gaming_bonus_rule_get_counter_rules 
	STRAIGHT_JOIN gaming_bonus_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rule_get_counter_rules.bonus_rule_id=gaming_bonus_rules.bonus_rule_id AND 
		(returnManualBonus OR gaming_bonus_rules.is_manual_bonus=0)
	STRAIGHT_JOIN gaming_bonus_rules_wgr_req_weights ON (operatorGameIDFilter=0 OR gaming_bonus_rules_wgr_req_weights.operator_game_id=operatorGameIDFilter) AND  
		gaming_bonus_rules.bonus_rule_id=gaming_bonus_rules_wgr_req_weights.bonus_rule_id 
	...
	-- Wager Restrictions
	SELECT gbrwr.bonus_rule_id, gbrwr.min_bet, gbrwr.max_bet, gbrwr.max_wager_contibution, max_wager_contibution_before_weight, release_every_amount, 
		max_bet_add_win_contr, gaming_currency.currency_id, currency_code, redeem_threshold 
	FROM gaming_bonus_rule_get_counter_rules
	...
	FROM gaming_bonus_rule_get_counter_rules 
	STRAIGHT_JOIN gaming_bonus_rules_rewards_tigger_bets ON bonus_rule_get_counter_id=bonusRuleGetCounterID 
		AND gaming_bonus_rules_rewards_tigger_bets.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id;
	
    -- Rule: Bonus Type - Rewards
	SELECT gaming_bonus_rules_rewards_tigger_rounds.bonus_rule_id, trigger_rule_index, num_rounds, min_bet_amount, give_amount 
	FROM gaming_bonus_rule_get_counter_rules 
	STRAIGHT_JOIN gaming_bonus_rules_rewards_tigger_rounds ON bonus_rule_get_counter_id=bonusRuleGetCounterID 
		AND gaming_bonus_rules_rewards_tigger_rounds.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id; 

	-- Rule Bundles
	SELECT bonus_bundles.parent_bonus_rule_id, bonus_bundles.child_bonus_rule_id, bonus_rules.name, bonus_rules.description
	FROM gaming_bonus_rule_get_counter_rules
	STRAIGHT_JOIN gaming_bonus_rules_bundles AS bonus_bundles ON bonus_rule_get_counter_id=bonusRuleGetCounterID 
		AND bonus_bundles.parent_bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id
	...
	-- Lottery Draws
	SELECT gaming_bonus_rules_wgr_draw_weights.bonus_rule_id, gaming_lottery_draws.lottery_draw_id, gaming_lottery_draws.game_id, 
		gaming_bonus_rules_wgr_draw_weights.bonus_wgr_req_weigth AS bonus_wgr_draw_weigth_override 
	FROM gaming_bonus_rule_get_counter_rules 
