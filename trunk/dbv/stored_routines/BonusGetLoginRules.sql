-- -------------------------------------
-- BonusGetLoginRules.sql
-- -------------------------------------
DROP procedure IF EXISTS `BonusGetLoginRules`;

DELIMITER $$
CREATE DEFINER=`bit8_admin`@`127.0.0.1` PROCEDURE `BonusGetLoginRules`(bonusRuleIDArray TEXT)
BEGIN
	...
	JOIN gaming_bonus_rule_get_counter_rules ON bonus_rule_get_counter_id=bonusRuleGetCounterID AND gaming_bonus_rules_logins_amounts.bonus_rule_id=gaming_bonus_rule_get_counter_rules.bonus_rule_id 
